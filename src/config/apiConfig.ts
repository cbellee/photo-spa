export const apiConfig = {
    ...
    photoApiEndpoint: import.meta.env.VITE_PHOTO_API_ENDPOINT || "/api", //"http://172.16.0.5:8080/api" // "https://photo.yellowocean-9bbacae4.uksouth.azurecontainerapps.io/api", 
    maxConcurrentUploads: Number(import.meta.env.VITE_MAX_CONCURRENT_UPLOADS) || 10,
}
